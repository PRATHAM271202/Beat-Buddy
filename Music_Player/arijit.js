...
const songs = [
     ...
     {
        id: '3',
        songName: `Oh desh mere<br>
        <div class="subtitle"> Arijit Singh</div>`,
        poster: "img/arijit/3.jpg"
     },
     {
        id: '4',
        songName: `Teri Shikayat kar do<br>
        <div class="subtitle">Arijit Singh</div>`,
        poster: "img/arijit/4.jpg"
     },
     {
        id: '5',
        songName: `Tera Yaar Hon Main<br>
        <div class="subtitle">Arijit Singh</div>`,
        poster: "img/arijit/5.jpg"
     },
     {
        id: '6',
        songName: `jeena jeena Mahi teri chunariyaa <br>
        <div class="subtitle">Arijit Singh</div>`,
     ...
     {
        id: '8',
        songName: `Hamari Adhoori Kahani<br>
        <div class="subtitle">Arijit Singh </div>`,
        poster: "img/arijit/8.jpg"
     },
     {
        id: '9',
        songName: `Naiki ki rahoon mai <br>
        <div class="subtitle">Arijit Singh</div>`,
...
function activateMenuSide() {
 ...
 function handleMediaQuery(mediaQuery) {
   if (mediaQuery.matches) {
     // If the viewport width is below 930px, add the click event listener to activate the menu side
